  function createFigureAndLayOut(self)
    ...
    self.fig = figure(...
      ...
      'Position',[55 39.9230769230769 self.minLayoutWidth self.minLayoutHeight],...
...
%      'ButtonDownFcn',@(hObject,eventdata)self.mainaxes_ButtonDownFcn(hObject,eventdata),...
    ...
    self.frameslider=uicontrol(...
      ...
      'Max',10000,...
      'Min',1,...
      'Position',[self.frameSliderNominalX self.frameSliderNominalY 98.4 self.frameSliderHeight],...
      'String',{  'Slider' },...
      'Style','slider',...
    ...
    uicontrol(...
      ...
      'String',{  'Delete the selected track from the frame'; ...
                  'after a selected frame to the end.'; ...
                  blanks(0); ...
                  '1) Scroll to the frame before the first track frame'; ...
                  'to be deleted. '; ...
                  '2) Click on the animal whose track is to be trimmed.'; ...
                  '3) Push "Do It" button. ' },...
      'Style','text',...
      'Tag','text14');
    
    deleteAtStartpanel = uipanel(...
      'Parent',self.fig,...
      'Units','characters',...
      'FontUnits','pixels',...
      'FontName','helvetica',...
      'FontSize',15,...
      'Title','Delete Start of Track...',...
      'Clipping','on',...
      'Position',[101.8 1.46153846153846 78.2 25.6923076923077],...
      'Visible','off',...
      'Tag','deleteAtStartpanel');
    self.deleteAtStartpanel=deleteAtStartpanel;
    
    self.deleteAtStartdoitbutton=uicontrol(...
      'Parent',deleteAtStartpanel,...
      'Units','characters',...
      'FontUnits','pixels',...
      'BackgroundColor',[0 0.561 0],...
      'Callback',@(hObject,eventdata)self.deleteAtStartdoitbuttonTwiddled(hObject,eventdata),...
      'CData',[],...
      'Enable','off',...
      'FontName','helvetica',...
      'FontSize',16,...
      ...
      'String','Do It',...
      'UserData',[],...
      'Tag','deleteAtStartdoitbutton');
    
    self.deleteAtStartcancelbutton=uicontrol(...
      'Parent',deleteAtStartpanel,...
      'Units','characters',...
      'FontUnits','pixels',...
      'BackgroundColor',[0.524 0 0],...
      'Callback',@(hObject,eventdata)self.deleteAtStartcancelbuttonTwiddled(hObject,eventdata),...
      'CData',[],...
      'Enable','off',...
      'FontName','helvetica',...
      'FontSize',16,...
    ...
    uicontrol(...
      ...
      'KeyPressFcn',@(hObject,eventdata)self.keyPressed(hObject,eventdata),...
      'Position',[1.4 7.15384615384615 66.4 16.1538461538462],...
      'String',{  'Delete the selected track from the start'; ...
                  'to the frame before a selected frame.'; ...
                  blanks(0); ...
                  '1) Scroll to the frame after the last track frame'; ...
                  'to be deleted. '; ...
                  '2) Click on the animal whose track is to be trimmed.'; ...
                  '3) Push "Do It" button. ' },...
      'Style','text',...
    ...
    self.playSeqButton=uicontrol(...
      'Parent',self.fig,...
      'Units','characters',...
      'FontUnits','pixels',...
      'BackgroundColor',[0 0.537 0],...
      'Callback',@(hObject,eventdata)self.playSeqButtonPressed(hObject,eventdata),...
      'CData',[],...
      'Enable','off',...
      'FontName','helvetica',...
      'FontSize',16,...
      ...
      'ForegroundColor',[1 1 1],...
      'KeyPressFcn',@(hObject,eventdata)self.keyPressed(hObject,eventdata),...
      'Position',[52 9.69230769230769 18 2.53846153846154],...
      'String','Play Seq',...
      'UserData',[],...
      'Tag','playSeqButton');
    
    self.playButton=uicontrol(...
      'Parent',self.fig,...
      'Units','characters',...
      'FontUnits','pixels',...
      'BackgroundColor',[0 0.537 0],...
      'Callback',@(hObject,eventdata)self.playButtonPressed(hObject,eventdata),...
      'CData',[],...
      'Enable','off',...
      'FontName','helvetica',...
      'FontSize',16,...
      ...
      'ForegroundColor',[1 1 1],...
      'KeyPressFcn',@(hObject,eventdata)self.keyPressed(hObject,eventdata),...
      'Position',[52+18+2 9.69230769230769 12 2.53846153846154],...
      'String','Play',...
      'UserData',[],...
      'Tag','playButton');
...
%         rgbImageFromPointerCData(zoomOutPointerCData(),backgroundColor));
    ...
    displaypanel = uipanel(...
      ...
      'Title','Display',...
      'Clipping','on',...
      'Position',[self.displayPanelNominalX self.displayPanelNominalY 97 8.07692307692308],...
      'Tag','displaypanel');
    ...
    uicontrol(...
      ...
      'HorizontalAlignment','left',...
      'KeyPressFcn',@(hObject,eventdata)self.keyPressed(hObject,eventdata),...
      'Position',[69.5 4 21 1.61538461538461],...
      'String','Length:',...
      'Style','text',...
      'Tag','text23');
    ...
    uicontrol(...
      ...
      'HorizontalAlignment','left',...
      'KeyPressFcn',@(hObject,eventdata)self.keyPressed(hObject,eventdata),...
      'Position',[2.4 1.1 16 1.61538461538462],...
      'String','Auto-Zoom:',...
      'Style','text',...
