...
%            'Callback',@(hObject,eventdata)MouseHouse_export('hTrain_Callback',hObject,eventdata,guidata(hObject)),...
            ...
            'Units','pixels',...
            'Title','Experiment',...
            'Position',[148.228043143298           9.0262390670554          491.756548536209          320.932944606414],...
            'Clipping','off',...
            'Tag','hExperiment');

            %experimentPanelPosition = get(self.experimentPanel_,'Position') ;
            %experimentPanelWidth = experimentPanelPosition(3) ;
            %experimentPanelHeight = experimentPanelPosition(4) ;            
            %experimentPanelNormedMultiplier = [experimentPanelWidth experimentPanelHeight experimentPanelWidth experimentPanelHeight]      
            ...
            'Style','listbox',...
            'Value',1,...
            'Position',[19.185573762193          143.155454204313          459.444003252516          100.834377315282],...
            ...
            'Style','text',...
            'Position',[19.185573762193          247.199160965659          131.269715215005          12.8373177842566],...
            'Children',[],...
...
%            'BackgroundColor',[0 1 1],...
            ...
            'Style','listbox',...
            'Value',1,...
            'Position',[19.185573762193          9.55335276967904          459.444003252516          100.834377315282],...
            'BackgroundColor',[1 1 1],...
            ...
            'Style','text',...
            'Position',[19.185573762193          113.597059531026          131.269715215005          12.8373177842566],...
            'Children',[],...
            'HorizontalAlignment','left', ...
...
%            'BackgroundColor',[1 0.8 0.2],...
            ...
            'Units','pixels',...
            'String','Choose',...
            'Position',[ 401.81133367574          274         75.6548536209554          24],...
...
%            'Callback',@(hObject,eventdata)MouseHouse_export('chooseExperimentButton_Callback',hObject,eventdata,guidata(hObject)),...
            ...
            'Style','text',...
            'Position',[ 18.4934086629002          276           374.07122068139          20],...
            'BackgroundColor',[1 1 1],...
            'Children',[],...
            ...
            %processingModePanelPosition = get(self.processingModeButtonGroup_,'Position') ;
            %processingModePanelWidth = processingModePanelPosition(3) ;
            %processingModePanelHeight = processingModePanelPosition(4) ;            
            %processingModePanelNormedMultiplier = [processingModePanelWidth processingModePanelHeight processingModePanelWidth processingModePanelHeight]      
