...
switch strctJob.m_sFunction
  case 'fnPostTracking',
    MotrModel.fnPostTracking(strctJob.m_acExperimentClips, ...
                             strctJob.m_sExpName, ...
                             strctJob.m_iClip, ...
                             strctJob.m_aiNumJobs(strctJob.m_iClip));    % SERE added strctJob.m_iClip, was passed the full vector of numjobs for all files rather than numjobs for that file
