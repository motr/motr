function goodContrastAviFromLowContrastAvi(outputFileName,inputFileName)

if isempty(outputFileName)
  [a,b]=fileparts(inputFileName);
  outputFileName=fullfile(a,[b '_better_contrast.avi']);
end

% Construct a histogram of pel values
nMaxFramesToSample=100;
histogram=videoHistogramFromNonRandomSample(inputFileName,nMaxFramesToSample);
