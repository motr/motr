function histogram=videoHistogramFromNonRandomSample(input_file_name,max_n_frames_to_sample)
...
if n_frames==0
  error('File %s says it has zero frames',input_file_name);
end

% get the frame size
first_frame=vr.read(1);
